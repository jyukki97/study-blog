...
2. [Traffic Cutover & Migration: 트래픽 전환을 안전하게 설계하는 법](/learning/deep-dive/deep-dive-traffic-cutover-migration/)
3. [백엔드 커리큘럼 심화: Shadow Traffic과 Dark Launch 운영 플레이북](/learning/deep-dive/deep-dive-shadow-traffic-dark-launch-playbook/)
4. [Drain-aware Deployment: 연결을 끊지 않는 배포 전략](/learning/deep-dive/deep-dive-drain-aware-deployment-playbook/)
5. [분산 트레이싱 도입 플레이북](/learning/deep-dive/deep-dive-distributed-tracing-adoption-playbook/)
