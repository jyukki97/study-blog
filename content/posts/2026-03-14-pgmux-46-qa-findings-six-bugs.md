...
이전에도 [보안 QA (15편)](/posts/2026-03-11-pgmux-15-security-qa-hardening/)에서 비슷한 작업을 했지만, 이번 소견은 보안보다는 **운영 안전성**에 초점이 맞춰져 있다. 커넥션 풀 수명주기, 설정 리로드, 장애 격리 같은 프로덕션에서 시간이 지나야 드러나는 종류의 버그들이다.
